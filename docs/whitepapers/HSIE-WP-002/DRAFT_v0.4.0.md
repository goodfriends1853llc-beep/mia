# HSIE-WP-002 — FINAL RELEASE CANDIDATE
...
**Draft Version:** v0.4.0  
**Document State:** FINAL RELEASE CANDIDATE  
...
**Owner Publication Authorization:** PENDING FINAL RELEASE REVIEW
...
# Final Release Candidate Control
